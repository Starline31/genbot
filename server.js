    ...
    if (err) {
      ...
      fs.readdir("premium", (err, pstockFiles) => {
        if (err) {
          ...
          <html>
          <head>
          <title>FA Gösterge Paneli</title>
          <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
          <link rel="icon" href="https://cdn.discordapp.com/attachments/1180454847649161296/1183057404095639702/image1.jpg" type="image/jpg">
              ...
              <ul>
                  <li>
                      <a href="#">
                          ...
                          <span class="title">Fast Account</span>
                      </a>
                  </li>
                  ...
                  <li>
                      <a href="/edit">
                          ...
                          <span class="title">Gösterge Paneli</span>
                      </a>
                  </li>
            ...
            <div class="cardBox">
                <div class="card">
                    ...
                    <div class="numbers">${freeLines + premiumLines}</div>
                        <div class="cardName">Toplam Stok</div>
                    </div>
                ...
                <div class="card">
                    <div>
                        ...
                        <div class="cardName">Ücretsiz Stok</div>
                    </div>
                ...
                <div class="card">
                    <div>
                        ...
                        <div class="cardName">Premium Stok</div>
                    </div>
    ...
    <div class="fancy-input-container">
      <div class="file-select">
        <select id="create-folder-select" name="folder" required>
          <option value="free">Ücretsiz Stok</option>
          <option value="premium">Premium Stok</option>
        </select>
      </div>
      ...
      <h2 class="section-title">Ücretsiz Stok Dosyaları</h2>
      <ul class="file-list" id="stock-files">
              ...
              <div class="files-section">
      <h2 class="section-title">Premium Stok Dosyaları</h2>
...
<div class="floating-heart">
		...
		<div class="tooltip">🖤Made In Mustifix💜</div>
	  </div>
...
app.get("/help", requireLogin, (req, res) => {
  ...
  <head>
  <title>Fast Account Yönetim | Yardım</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
    <link rel="icon" href="https://cdn.discordapp.com/attachments/1180454847649161296/1183057404095639702/image1.jpg" type="image/jpg">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/ionicons@6.0.1/dist/css/ionicons.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
...
.bot-commands strong {
    color: var(--green); /* Bot komut adlarının rengini özelleştirme */
}
...
<div class="bot-commands">
    ...
    <ul>
        <li>
            <strong>/yardım</strong>: Botun komutlarını gösterir.
        </li>
        <li>
            <strong>/oluştur</strong>: Yeni bir hizmet oluşturur.
        </li>
        <li>
            <strong>/ucretsiz</strong>: Ücretsiz gen oluşturur.
        </li>
        <li>
            <strong>/ekle</strong>: Stok ekler.
        </li>
        <li>
            <strong>/stok</strong>: Stokları görüntüler.
        </li>
        <li>
            <strong>/premium</strong>: Premium gen oluşturur.
        </li>
    </ul>
</div>
...
<div class="features">
    <h2>Özellikler</h2>
    <ul>
      <li><strong>Otomatik Çekilişler:</strong> Fast Account, baştan sona tüm hediye sürecini otomatikleştirir. Çekiliş parametrelerini ayarlamanız yeterli; katılımcı giriş takibi, kazanan seçimi ve ödül dağıtımı da dahil olmak üzere gerisini Fast Account halledecektir.</li>
      <li><strong>Emniyet ve güvenlik:</strong> Fast Account güvenli ve emniyetli bir hediye deneyimi sağlar. Bot, hileli girişleri önlemek için çeşitli hile karşıtı önlemler kullanarak tüm katılımcılar için adaleti sağlar.</li>
      <li><strong>Kolay Yapılandırma:</strong> Fast Account'u açmak çocuk oyuncağı. Bot, sezgisel ve kullanıcı dostu bir kurulum süreci sağlayarak hediye ayarlarını tercihlerinize göre yapılandırmanız için her adımda size yol gösterir.</li>
    </ul>
  </div>
...
app.get("/settings", requireLogin, (req, res) => {
  ...
  <head>
  <title>FA Gösterge Paneli | Ayarlar</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
  <link rel="icon" href="https://cdn.discordapp.com/attachments/1180454847649161296/1183057404095639702/image1.jpg" type="image/jpg">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/ionicons@6.0.1/dist/css/ionicons.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
...
.bot-commands strong {
      ...
      <ul>
          <li>
              <a href="#">
                  ...
                  <span class="title">FA Master</span>
              </a>
          </li>
  ...
  <div class="main">
    ...
    <form id="settings-form">
        ...
        <label for="genCooldown">Ücretsiz Bekleme Süresi: (saniye)</label>
        ...
        <label for="footer">Oynuyor Yazısı:</label>
...
settingsForm.addEventListener("submit", async (event) => {
  ...
  if (response.ok) {
    ...
    alert("Ayarlar kaydedilemedi kaydedilemedi!");
  }
});
...
app.post("/save-settings", requireLogin, (req, res) => {
  ...
  fs.readFile("./config.json", "utf8", (err, data) => {
    ...
    fs.writeFile("./config.json", JSON.stringify(config, null, 2), (err) => {
      if (err) {
        console.error("Yapılandırma dosyası yazılırken hata oluştu:", err);
        res.status(500).json({
  ...
  if (folder === "free" || folder === "premium") {
    ...
    fs.writeFile(`${folder}/${fullFileName}`, "", (err) => {
      if (err) {
        ...
        res.send("Dosya başarıyla oluşturuldu!");
      }
    });
  } else {
    res.send("Geçersiz klasör seçimi");
  }
});
...
<html>
<head>
<title>Fast Account Editor</title>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
<link rel="icon" href="https://cdn.discordapp.com/attachments/1180454847649161296/1183057404095639702/image1.jpg" type="image/jpg">
